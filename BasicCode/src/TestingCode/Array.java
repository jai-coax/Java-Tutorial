...
public class Array {
	...
	public static void main(String[] args) {
		...
		int set[]; // type 1 -  Declaration - Which wont allocate memory
		...
		int setup[] = {1,2,3,4,5}; // type 2 - Declaration and instantiation and initialization   
		...
		System.out.println("hello sample" + " " + setup[4]);
